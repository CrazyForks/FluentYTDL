...
class CoverDownloadPage(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        # 1. Title
        self.titleLabel = SubtitleLabel(self.tr("封面下载"), self)
        ...
        self.instructionLabel = BodyLabel(self.tr("在此处粘贴 YouTube 视频链接以下载封面"), self)
        ...
        self.parseBtn = PrimaryPushButton(FluentIcon.SEARCH, self.tr("获取封面"), self)
        ...
        self.tipsLabel = CaptionLabel(
            self.tr("提示：将解析视频并显示封面预览，支持保存最高质量封面。"),
            self,
        )
